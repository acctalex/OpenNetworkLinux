...
class OnlPlatform_x86_64_accton_es8632bt4_r0(OnlPlatformAccton,
                                              OnlPlatformPortConfig_32x400_2x10):

    PLATFORM='x86-64-accton-es8632bt4-r0'
    MODEL="IXR7220-D5"
    SYS_OBJECT_ID=".7220.D5"

    def baseconfig(self):
        self.insmod('optoe')
        self.insmod('accton_i2c_psu')
        for m in [ 'cpld', 'fan', 'psu', 'leds' ]:
            self.insmod("x86-64-accton-es8632bt4-%s.ko" % m)
        ...
        self.new_i2c_devices([
            # initialize CPLD
             #initiate CPLD
            ('es8632bt4_fpga', 0x60, 1),            
            ('es8632bt4_cpld1', 0x61, 10),
            ('es8632bt4_cpld2', 0x62, 10),
            ])
        self.new_i2c_devices([
            # initiate fan
              # initiate chassis fan
            ('es8632bt4_fan', 0x66, 14),
        ...
        self.new_i2c_devices([
            # initiate PSU-1
            ('es8632bt4_psu1', 0x51, 9),
            ('acbel_fsh082', 0x59, 9),           

            # initiate PSU-2
            ('es8632bt4_psu2', 0x50, 9),
            ('acbel_fsh082', 0x58, 9),
         ])
