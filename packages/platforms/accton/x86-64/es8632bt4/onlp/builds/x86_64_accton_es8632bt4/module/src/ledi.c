...
#define prefix_path "/sys/class/leds/accton_es8632bt4_led::"
...
{LED_STAT, LED_MODE_GREEN_BLINK, ONLP_LED_MODE_GREEN_BLINKING},
{LED_STAT, LED_MODE_AMBER, ONLP_LED_MODE_ORANGE},
...
static onlp_led_info_t linfo[] =
{
	{ }, /* Not used */
	{
		{ ONLP_LED_ID_CREATE(LED_STAT), "LED 1 (STAT LED)", 0 },
		ONLP_LED_STATUS_PRESENT,
		ONLP_LED_CAPS_ON_OFF | ONLP_LED_CAPS_GREEN | 
		ONLP_LED_CAPS_BLUE | ONLP_LED_CAPS_GREEN_BLINKING | 
...
{
	onlp_ledi_mode_set(ONLP_LED_ID_CREATE(LED_STAT), ONLP_LED_MODE_OFF);
