...
#define ES8632BT4_THERMAL_CAPS (ONLP_THERMAL_CAPS_GET_TEMPERATURE | \
...
static onlp_thermal_info_t linfo[] = {
	...
	{ { ONLP_THERMAL_ID_CREATE(THERMAL_CPU_CORE), "CPU Core", 0}, 
	    ...
	    ES8632BT4_THERMAL_CAPS, 0, ONLP_THERMAL_THRESHOLD_INIT_DEFAULTS
	},	
	...
	{ { ONLP_THERMAL_ID_CREATE(THERMAL_6_ON_MAIN_BROAD), "LM75-6-4F", 0}, 
	    ONLP_THERMAL_STATUS_PRESENT,
	    ES8632BT4_THERMAL_CAPS, 0, ONLP_THERMAL_THRESHOLD_INIT_DEFAULTS
	},
