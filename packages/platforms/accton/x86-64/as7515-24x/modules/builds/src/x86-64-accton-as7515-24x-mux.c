...
static int as7515_24x_cpld_mux_reg_write(struct i2c_adapter *adap,
...
static int as7515_24x_mux_select_chan(struct i2c_mux_core *muxc, u32 chan)
{
	...
	case as7515_fpga_mux:
		...
		ret = as7515_24x_cpld_mux_reg_write(muxc->parent, client, 
				chips[data->type].select_reg, reg_val);
		break;
