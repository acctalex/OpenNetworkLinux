...
sys_led_sysfs=("/sys/class/leds/diag/brightness" \
               "/sys/class/leds/poe/brightness" \
               "/sys/class/leds/fan/brightness" \
               "/sys/class/leds/pri/brightness" \
               "/sys/class/leds/psu1/brightness" \
               "/sys/class/leds/psu2/brightness" \
               "/sys/class/leds/stk1/brightness" \
               "/sys/class/leds/stk2/brightness")
