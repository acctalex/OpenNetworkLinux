...
#define LED_FORMAT "/sys/devices/platform/as9737_32db_led/%s"
...
led_light_mode_map_t led_map[] = {
	...
	{ LED_LOC,  LED_MODE_YELLOW_BLINKING, ONLP_LED_MODE_YELLOW_BLINKING},
...
static onlp_led_info_t linfo[] =
{
	...
	},
	{
		...
		ONLP_LED_STATUS_PRESENT,
		ONLP_LED_CAPS_ON_OFF | ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_YELLOW | 
