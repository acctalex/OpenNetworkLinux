...
#define ES7636BT4_THERMAL_CAPS (ONLP_THERMAL_CAPS_GET_TEMPERATURE | \
...
static onlp_thermal_info_t linfo[] = {
	...
	{ { ONLP_THERMAL_ID_CREATE(THERMAL_CPU_CORE), "CPU Core", 0}, 
	    ...
	    ES7636BT4_THERMAL_CAPS, 0, {52000, 57000, 62000}
	},	
	{ { ONLP_THERMAL_ID_CREATE(THERMAL_1_ON_MAIN_BROAD), "LM75-1-48", 0}, 
	    ONLP_THERMAL_STATUS_PRESENT,
	    ES7636BT4_THERMAL_CAPS, 0, {58000, 63000, 68000}
	},
	...
	{ { ONLP_THERMAL_ID_CREATE(THERMAL_1_ON_PSU1), 
	    ...
	    ONLP_THERMAL_STATUS_PRESENT,
	    ES7636BT4_THERMAL_CAPS, 0, ONLP_THERMAL_THRESHOLD_INIT_DEFAULTS
	},
...
int onlp_thermali_info_get(onlp_oid_t id, onlp_thermal_info_t* info)
{
	...
	*info = linfo[tid];
	if (tid == THERMAL_CPU_CORE)
		return onlp_file_read_int_max(&info->mcelsius, 
					      cpu_coretemp_files);
