...
class OnlPlatform_x86_64_accton_as9817_32d_r0(OnlPlatformAccton,
                                              OnlPlatformPortConfig_32x800_2x25):
    PLATFORM='x86-64-accton-as9817-32d-r0'
    MODEL="AS9817-32D"
    SYS_OBJECT_ID=".9817.32"
    ...
    def baseconfig(self):
        ...
        for m in [ 'i2c-ocores', 'fpga', 'mux', 'fan', 'psu', 'thermal', 'sys', 'leds' ]:
            self.insmod("x86-64-accton-as9817-32-%s" % m)

        ########### initialize I2C bus 0 ###########
        self.new_i2c_devices(
            [
                # initialize multiplexer (PCA9548)
                ('as9817_32_mux', 0x78, 0),
        ...
        for port in range(1, 33):
            subprocess.call('echo 0 > /sys/devices/platform/as9817_32_fpga/module_reset_%d' % (port), shell=True)
