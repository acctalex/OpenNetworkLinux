...
static char* devfiles__[] = { /* must map with onlp_thermal_id */
    NULL,
    NULL,                  /* CPU_CORE files */
    "/sys/devices/platform/as9817_32_thermal*temp1_input",
    "/sys/devices/platform/as9817_32_thermal*temp2_input",
    "/sys/devices/platform/as9817_32_thermal*temp3_input",
    "/sys/devices/platform/as9817_32_thermal*temp4_input",
    "/sys/devices/platform/as9817_32_thermal*temp5_input",
...
onlp_thermali_info_get(onlp_oid_t id, onlp_thermal_info_t* info)
{
    ...
    *info = tinfo[tid];
    ...
    if ((tid >= THERMAL_1_ON_PSU1) && (tid <= THERMAL_3_ON_PSU2)) {
        ...
        if (onlp_get_psu_power_good(psu_id) != ONLP_STATUS_OK) {
