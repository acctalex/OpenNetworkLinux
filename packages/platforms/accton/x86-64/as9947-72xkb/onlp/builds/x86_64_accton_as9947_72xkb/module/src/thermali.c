...
static char* devfiles__[] = { /* must map with onlp_thermal_id */
    ...
    "/sys/devices/platform/as9947_72xkb_psu.0*psu1_temp1_input",
    "/sys/devices/platform/as9947_72xkb_psu.0*psu1_temp2_input",
    "/sys/devices/platform/as9947_72xkb_psu.0*psu1_temp3_input",
    "/sys/devices/platform/as9947_72xkb_psu.1*psu2_temp1_input",
    "/sys/devices/platform/as9947_72xkb_psu.1*psu2_temp2_input",
    "/sys/devices/platform/as9947_72xkb_psu.1*psu2_temp3_input"
};
...
static onlp_thermal_info_t tinfo[] = {
    ...
    {   { ONLP_THERMAL_ID_CREATE(THERMAL_1_ON_FAN_BROAD), "MB_CenterRight_temp(0x4D)", 0, {0} },
        ONLP_THERMAL_STATUS_PRESENT,
        ONLP_THERMAL_CAPS_ALL, 0, ONLP_THERMAL_THRESHOLD_INIT_DEFAULTS
    },
    {   { ONLP_THERMAL_ID_CREATE(THERMAL_2_ON_FAN_BROAD), "FCB_Up_temp(0x4D)", 0, {0} },
        ONLP_THERMAL_STATUS_PRESENT,
        ONLP_THERMAL_CAPS_ALL, 0, ONLP_THERMAL_THRESHOLD_INIT_DEFAULTS
    },
