...
class OnlPlatform_x86_64_accton_as9957_32db_r0(OnlPlatformAccton,
                                              OnlPlatformPortConfig_32x800_4x25):
    PLATFORM='x86-64-accton-as9957-32db-r0'
    MODEL="AS9957-32DB"
    SYS_OBJECT_ID=".9957.32"
    ...
    def baseconfig(self):
        ...
        for m in [ 'i2c-ocores', 'fpga', 'fan', 'psu', 'thermal', 'sys', 'leds' ]:
            self.insmod("x86-64-accton-as9957-32db-%s" % m)

        # initialize SFP devices
        for port in range(1, 33):
            subprocess.call('echo 0 > /sys/devices/platform/as9957_32db_fpga/module_reset_%d' % (port), shell=True)
